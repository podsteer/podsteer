...
// newTLSTestAdapter returns an Adapter whose client for id is the fake
...
func newTLSTestAdapter(id domain.ClusterID, objects ...runtime.Object) *Adapter {
...
func TestInspectTLSSecretReadsTheLeafAndMatchesTheKey(t *testing.T) {
	...
	adapter := newTLSTestAdapter(id, secret)
