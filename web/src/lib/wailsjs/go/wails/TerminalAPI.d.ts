...
export function DetectAgents():Promise<Array<wails.CodingAgentDTO>>;

export function LocalShellSupported():Promise<wails.LocalShellSupportDTO>;

export function Resize(arg1:string,arg2:number,arg3:number):Promise<void>;

export function StartAgentSession(arg1:string,arg2:string,arg3:string,arg4:string,arg5:string,arg6:boolean,arg7:number,arg8:number):Promise<string>;
...
export function StartLocalSession(arg1:string,arg2:number,arg3:number):Promise<string>;
